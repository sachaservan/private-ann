   ...
   do
      for numprobes in 1 5 10 50 100 500
         do 
            ...
            bash server.sh --dataset ../datasets/sift --cachedir ../cache --numtables ${numtables} --hashrange 35 --numprobes ${numprobes} --bucketcap 1 --maxval 1000 --pwm 129.30 --pws 43.46 --procs ${numtables} "$@"
         done 
   done
