   ...
   do
      for numprobes in 1 5 10 50 100 500
         do 
            ...
            bash server.sh --dataset ../datasets/mnist --cachedir ../cache --numtables ${numtables} --numprobes ${numprobes} --bucketcap 1 --maxval 1000 --pwm 887.7 --pws 244.9 --procs ${numtables} "$@"
         done 
   done
