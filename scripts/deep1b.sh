   ...
   do
      for numprobes in 1 5 10 50 100 500
         do 
            ...
            bash server.sh --dataset ../datasets/deep1b --cachedir ../cache --numtables ${numtables} --numprobes ${numprobes} --bucketcap 1 --maxval 1000 --pwm 0.4094 --pws 0.097486 --procs ${numtables} "$@"
         done 
   done
